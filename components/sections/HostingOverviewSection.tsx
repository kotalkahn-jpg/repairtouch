  ...
  const services = [
    {
      ...
      desc: "Launch and scale your business online with fast, reliable hosting environments tailored for performance, uptime, and growth. We ensure your website remains accessible, secure, and optimized at all times.",
      image: "/web.jpg",
    },
    {
      title: "Email Hosting",
      desc: "Build professional communication channels with secure and reliable email hosting. We provide business-grade email systems that enhance credibility and ensure uninterrupted communication.",
      image: "/mail.jpg",
    },
    {
      title: "Domain & DNS Setup",
      desc: "We handle complete domain configuration and DNS management, ensuring your services are correctly routed, globally accessible, and optimized for performance.",
      image: "/host.jpg",
    },
  ]
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center max-w-3xl mx-auto mb-24">
          ...
          <p className="text-gray-600">
            Everything your business needs to operate online — built with
            reliability, scalability, and performance in mind.
          </p>
        </div>
